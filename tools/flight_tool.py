...
DEFAULT_ORIGIN_DATA = os.getenv("DEFAULT_ORIGIN_DATA", "CCU")

BASE_URL = 'https://api.aviationapi.com/v1/flights'
...
def airport_country_matches(airport: Airport, country_code: str) -> bool:
...
if __name__ == "__main__":
    print(search_flights("Plan a 7 days Japan trip from Kolkata"))
    print("\n" + "=" * 80 + "\n")
